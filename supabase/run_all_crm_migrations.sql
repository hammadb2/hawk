...
-- If something fails (e.g. already applied), fix or skip that block and re-run the rest.
-- Trailing SELECT is optional read-only RLS inspection — comment it out if you only want DDL.
-- =============================================================================
...
-- >>> migrations/20260416000001_readiness_guarantee.sql >>>
...
-- >>> migrations/20260410000001_profiles_role_closer.sql + 20260417000001_profiles_role_client.sql (merged) <<<
-- Closer-only constraint fails when portal users already have role = 'client' (23514).
...
-- >>> migrations/20260425000001_profiles_role_type_va_rls.sql <<<
...
-- >>> migrations/20260406120000_clients_billing_status.sql >>>
