      ...
      <div className={`w-full max-w-lg p-6 shadow-xl ${crmSurfaceCard}`}>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-200">Role</label>
              <input
                type="text"
                value={terms.role}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-200">Start Date</label>
              <input
                type="date"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-200">Base Rate</label>
              <input
                type="text"
                placeholder="e.g. $500"
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-ink-200">Rate Frequency</label>
              <select
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-ink-200">Bonus Structure</label>
            <textarea
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-ink-200">Custom Clauses (optional)</label>
            <textarea
