...
function objectionTemplates(industry: string | null): { objection: string; response: string }[] {
  ...
  if (isHealth) {
    return [
      ...
      { objection: "This sounds expensive for what we get.", response: "Compare to one privacy incident: HIPAA breach notification, downtime, and reputation damage typically dwarf preventive monitoring. Starter is $199/mo to see value before Shield." },
    ];
  }
  if (isLegal) {
    return [
