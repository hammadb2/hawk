  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="border-zinc-800 bg-zinc-950">
        <DialogHeader>
          <DialogTitle className="text-zinc-100">Log call</DialogTitle>
        </DialogHeader>
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-zinc-400">Duration (min)</Label>
              <Input className="border-zinc-700 bg-zinc-900" value={duration} onChange={(e) => setDuration(e.target.value)} type="number" min={0} />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea className="mt-1 w-full rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-100" rows={3} value={summary} onChange={(e) => setSummary(e.target.value)} />
          </div>
          <div>
            <Label className="text-zinc-400">Next action</Label>
            <Input className="border-zinc-700 bg-zinc-900" value={nextAction} onChange={(e) => setNextAction(e.target.value)} placeholder="Follow-up in 3 days…" />
          </div>
        </div>
        <DialogFooter>
