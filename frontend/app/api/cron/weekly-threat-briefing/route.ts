...
/** Calls Railway/backend Phase 2 weekly threat briefing job. Schedule: Mondays 14:00 UTC (~7am MT). */
export async function GET(request: Request) {
  ...
  const res = await fetch(`${API_URL}/api/crm/cron/weekly-threat-digest`, {
    method: "POST",
