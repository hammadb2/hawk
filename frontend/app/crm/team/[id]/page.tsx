...
export default function TeamMemberProfilePage() {
  ...
  if (!target) {
    return <p className="p-6 text-sm text-slate-600">Team member not found.</p>;
  }
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <Link href="/crm/team" className="text-sm text-emerald-600 hover:underline">
        ← Back to team
      </Link>

      <div>
        <h1 className="text-2xl font-semibold text-slate-900">
          {target.full_name ?? target.email ?? "Team member"}
        </h1>
